...
//获取订单对象
$orderInfo = $db->find("SELECT * FROM duo_recharge WHERE id = {$_GET['state']}");
//微信支付标题
...
$orderArgsObj->SetNotify_url(WxPayConfig::DUO_COIN_NOTIFY_URL);//异步通知url
...
$smarty->display($_SERVER['DOCUMENT_ROOT']."/template/front/duo/{$curTemplate}/page/recharge/paymentRecharge.html");
