...
class WxPayApi
{
	 ...
	 * @return 成功时返回，其他抛异常
	 */
	public static function unifiedOrder($inputObj, $timeOut = 6,$wxAppSate = 0)
	{
		...
		if($wxAppSate == 1){//开启微信小程序支付
		    $inputObj->SetAppid(WxPayConfig::WXAPPID);//微信小程序公众账号ID
		    $inputObj->SetMch_id(WxPayConfig::WXMCHID);//微信小程序商户号
		}else{
	 ...
	 * @return 成功时返回，其他抛异常
	 */
	public static function transfers($xml, $timeOut = 6)
	{
	    $url = "https://api.mch.weixin.qq.com/mmpaymkttransfers/promotion/transfers";
	    $startTimeStamp = self::getMillisecond();//请求开始时间
	    $response = self::postXmlCurl($xml, $url, true, $timeOut);
	    $result = WxPayResults::TransfersInit($response);
