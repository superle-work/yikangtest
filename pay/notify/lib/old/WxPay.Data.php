...
class WxPayResults extends WxPayDataBase
{
     ...
     * @throws WxPayException
	 */
	public static function TransfersInit($xml){
	    $obj = new self();
	    $obj->FromXml($xml);
	    return $obj->GetValues();
	}
...
{	
	...
	**/
	...
	/**
	 * 设置微信小程序开启状态 0 未开启 1 开启
	 * @param string $value
	 **/
	public function SetWXapp_state($value)
	{
	    $this->values['wxapp_state'] = $value;
	}
	 ...
	 * @return 值
	 */
	public function GetWXapp_state()
	{
	    return $this->values['wxapp_state'];
	}
	 ...
	 * @return true 或 false
	 */
	public function IsWXapp_stateSet()
	{
	    return array_key_exists('wxapp_state', $this->values);
	}
