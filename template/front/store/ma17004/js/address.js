...
var addressInit = function(_cmbProvince, _cmbCity, _cmbArea, defaultProvince, defaultCity, defaultArea)
{
	...
	function changeProvince()
	{
        ...
        if(cmbCity != null && cmbCity !=""){//存在城市DOM对象时执行
...
{name:'芜湖市', areaList:['镜湖区','马塘区','新芜区','鸠江区','芜湖县','繁昌县','南陵县','无为县']},
{name:'蚌埠市', areaList:['龙子湖区','蚌山区','禹会区','淮上区','怀远县','五河县','固镇县']},		   
{name:'淮南市', areaList:['大通区','田家庵区','谢家集区','八公山区','潘集区','凤台县']},		   
{name:'马鞍山市', areaList:['金家庄区','花山区','雨山区','当涂县','含山县','和　县']},		   
