        ...
        $.ajax({
            ...
            success:function(json){
                ...
                if(json.errorCode == 0){
                    ...
                    html+='<tr><th class="th1">序号</th><th class="th3">缩略图</th><th class="th2">商品名称</th><th class="th4">标准价格</th><th class="th10">销量</th><th class="th5">排序系数</th><th class="th6">状态</th><th class="th7">首页推荐</th><th class="th8">创建日期</th></tr>';
                    ...
                    for(var i = 0; i < myList.length;i++){
                        ...
                        html+='<tr>'
                                 ...
                                 +'<td><a href="./admin.php?c=store_goods&a=goodsDetail&id='+ gid +'">'+ name +'</a></td>'
                                 +'<td>'+price+'</td>'
                                 +'<td>'+quantity+'</td>'
                                 +'<td>'+sortnum+'</td>'
