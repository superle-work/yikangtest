        ...
        $.ajax({
            ...
            success:function(result){
                ...
                if(result.errorCode == 0){
                    ...
                    html+='<tr><th class="th1">序号</th><th class="th3">缩略图</th><th class="th2">商品名称</th><th class="th7">价格</th><th class="th10">销量</th><th class="th5">排序</th><th class="th6">状态</th><th class="th7">首页推荐</th><th class="th8">添加日期</th></tr>';
