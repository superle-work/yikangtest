$(function(){
    ...
    function render(async,pageIndex,pageSize){
        ...
        $.ajax({
            async:async,
            type:'post',
            url:'./admin.php?c=store_hospital&a=pagingCancelOrder',
            ...
            success:function(json){
                ...
                if(json.errorCode == 0){
                    ...
                    html+='<tr><th class="th1">序号</th><th class="th3">昵称</th><th class="th4">订单号</th><th class="th11">订单总价</th><th class="th11">订单状态</th><th class="th3">核销人员</th><th class="th8">送检时间</th><th class="th8">下单时间</th></tr>';
                    ...
                    for(var i = 0; i < myList.length;i++){
                        ...
                        var user_name = obj.hospital_worker_name;  //医院工作人员昵称
                        var user_id = obj.hospital_worker;         //医院工作人员id
