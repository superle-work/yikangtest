$(function(){
    ...
    function arrowEvent(){
        $("#list-table .cat-stored.cat-level-1 .arrow").die("click");
        $("#list-table .cat-stored.cat-level-1 .arrow").live('click',function(){
                ...
                if(json.errorCode == 0){
                    ...
                    for(var i=0,l=data.length;i<l;i++){
                        ...
                        var cate = {"rank":selectInfo.rank,
                            ...
                            "fou":""};
                        var statusOper = "";
                        var templateHtml = "<a class='edit' href='./admin.php?c=store_category&a=editCategory&rank=1&id="+data[i].id+"'>编辑分类</a>";
                ...
                if(json.errorCode == 0){
                    ...
                    for(var i=0,l=data.length;i<l;i++){
                        ...
                        if(selectInfo.rank == 2){//当前子类为二级分类
                            ...
                            cate.sec = data[i].sec;
                            arrowClass ="hidden";
                            addSubHtml = "<a class='edit' href='./admin.php?c=store_category&a=editCategory&rank=2&id="+data[i].id+"'>编辑分类</a>";
                        }
