$(function(){
    ...
    var  goodsFormOptions={
        url:'./admin.php?c=store_clinic&a=updateClinic',
	...
	function setMap(keyword,type=2){
        ...
        if(keyword){
            ...
            if(type != 1){
                ...
                markerArr = [{title:"诊所地址",content:keyword,point:lng+"|" + lat,isOpen:1,icon:{w:21,h:21,l:0,t:0,x:6,lb:5}}];
	...
	function showInfo(e){
		...
		geoc.getLocation(e.point, function(rs){
			...
			//标注点数组
		    markerArr = [{title:"诊所地址",content:content_text,point:e.point.lng+"|" + e.point.lat,isOpen:1,icon:{w:21,h:21,l:0,t:0,x:6,lb:5}}];
			//$(".content .inner-section .map-search-row .keyword").val(content_text);
