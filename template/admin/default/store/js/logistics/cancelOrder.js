$(function(){
    ...
    function render(async,pageIndex,pageSize){
        ...
        $.ajax({
            async:async,
            type:'post',
            url:'./admin.php?c=store_logistics&a=pagingCancelOrder',
            ...
            success:function(json){
                ...
                if(json.errorCode == 0){
                    ...
                    html+='<tr><th class="th1">序号</th><th class="th3">昵称</th><th class="th11">订单号</th><th class="th4">订单总价</th><th class="th4">订单状态</th><th class="th3">核销人员</th><th class="th8">送检时间</th><th class="th8">下单时间</th><th class="th8">完成时间</th></tr>';
                    var colspan = $(html).find("th").length;
                    for(var i = 0; i < myList.length;i++){
                        var obj = myList[i];
                        var num = (pageIndex-1)*pageSize + i+1;
                        var nick_name = obj.nick_name;   //下单人昵称
                        var account = obj.account;
                        var order_num = obj.order_num;
                        var total_price = obj.total_price;
                        var user_name = obj.logistics_worker_name;  //物流人员名称
                        var user_id = obj.logistics_worker;   //物流人员id
                        var check_time = obj.check_time?obj.check_time:'---';
                        var end_time = obj.end_time?obj.end_time:'---';
