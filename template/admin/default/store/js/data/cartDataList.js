    ...
    function cartGoodsRankList(){
        ...
        $.ajax({
            ...
            success:function(result){
                    ...
                    html = "<tr><th>排行</th><th class='th2'>商品名称</th><th class='th3'>价格</th><th class='th4'>加入购物车次数</th></tr>";
                    if(goodsTimesList.length > 0){
                        for(var i = 0; i <goodsTimesList.length; i++){
                            var obj = goodsTimesList[i];
                            html +="<tr><td>"+(i+1)+"</td><td>"+obj.goods_name+"</td><td>"+obj.price+"</td><td>"+obj.total_count+"</td></tr>";
                        }
                    }else{
                    ...
                    html = "<tr><th>排行</th><th class='th2'>商品名称</th><th class='th3'>价格</th><th class='th4'>加入购物车数量</th></tr>";
