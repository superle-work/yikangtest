<?php /* Smarty version Smarty-3.0.8, created on 2019-11-20 07:29:13
         compiled from "C:\phpStudy\PHPTutorial\WWW\yxj/template\../template/admin/default/store/page/goods/editGoods.html" */ ?>
<?php /*%%SmartyHeaderCode:139915dd4eb490715b8-35173241%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f587d4095532c8f1db8725d91f2d8699656c26c8' => 
    array (
      0 => 'C:\\phpStudy\\PHPTutorial\\WWW\\yxj/template\\../template/admin/default/store/page/goods/editGoods.html',
      1 => 1574234950,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '139915dd4eb490715b8-35173241',
  'function' => 
  array (
  ),
                            ...
                            <td class="td2">
                                ...
                                <div class="layui-form-item">
                                    ...
                                    <label class="layui-form-label pca-label-province" >
                                        <input name="name" lay-verify="required" disabled="disabled" autocomplete="off" class="layui-input" type="disabled" value="<?php if ($_smarty_tpl->getVariable('goods')->value['province']!=null){?><?php echo $_smarty_tpl->getVariable('goods')->value['province'];?>
<?php }?>">
                                    </label>
                                    <label class="layui-form-label pca-label-city">
                                        <input name="name" lay-verify="required" disabled="disabled" autocomplete="off" class="layui-input" type="disabled" value="<?php if ($_smarty_tpl->getVariable('goods')->value['city']!=null){?><?php echo $_smarty_tpl->getVariable('goods')->value['city'];?>
<?php }?>">
                                    </label>
                                    <label class="layui-form-label pca-label-area">
                                        <input name="name" lay-verify="required" disabled="disabled" autocomplete="off" class="layui-input" type="disabled" value="<?php if ($_smarty_tpl->getVariable('goods')->value['area']!=null){?><?php echo $_smarty_tpl->getVariable('goods')->value['area'];?>
<?php }?>">
                                    </label>
                                </div>
                            </td>
...
">
                                ...
                                <input type="hidden" id='textprovince' name="textprovince" value="<?php echo $_smarty_tpl->getVariable('goods')->value['province'];?>
">

                                <input type="hidden" id='textcity' name="textcity" value="<?php echo $_smarty_tpl->getVariable('goods')->value['city'];?>
">

                                <input type="hidden" id='textarea' name="textarea" value="<?php echo $_smarty_tpl->getVariable('goods')->value['area'];?>
">
