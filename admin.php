...
$spConfig = array(
		'mode'=>'debug',
		'default_controller' => 'base_index', 	// 默认的控制器名称
		'default_action' => 'index',  		// 默认的动作名称
		'url_controller' => 'c',  				// 请求时使用的控制器变量标识
		'url_action' => 'a',  					// 请求时使用的动作变量标识
		'dispatcher_error' => "import(APP_PATH.'/template/admin/404.html');exit();", // 定义处理路由错误的函数
...
import(BASE_PATH."/include/wechatUtil/ResponsePassive.php");
import(BASE_PATH."/include/wechatUtil/FansManage.php");
import(BASE_PATH."/include/wechatUtil/Broadcast.php");
import(BASE_PATH."/include/wechatUtil/Media.php");
import(BASE_PATH."/include/wechatUtil/Menu.php");
import(BASE_PATH."/include/wechatUtil/WeChatOAuth.php");
