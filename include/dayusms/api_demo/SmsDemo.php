...
class SmsDemo
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAI4FqBu6uw2ACRaHqCJcMg"; // AccessKeyId

        $accessKeySecret = "wHCdqd4xrzdm0A62IouKpgq58wyBcr"; // AccessKeySecret
     ...
     * @return stdClass
     */
    public static function sendSms($num,$phone) {
        ...
        $request->setSignName("易康绑定会员");
				
        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode("SMS_174813931");
