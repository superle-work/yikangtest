...
XML;
     ...
     * @param $fromusername
     * @param $tousername
     * @param $itemList 数组，每个项由self::newsItem()返回
     * @param $funcFlag 默认为0，设为1时星标刚才收到的消息
     * @return string
     */
    public static function news($fromusername, $tousername, $itemList, $funcFlag=0){
        //多条图文消息信息，默认第一个item为大图,注意，如果图文数超过10，则将会无响应
        if(count($itemList) >= 10){
...
XML;
        return sprintf($template, $fromusername, $tousername, time(), count($itemList), implode($itemList), $funcFlag);
    }
